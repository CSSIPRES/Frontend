...
import {
  MatDialog, MatSnackBar, NativeDateAdapter
    ...
    this.immatForm = this.fb.group({
      input: this.fb.group({
        ...
        documents: this.fb.group({
          demandeEcrit: this.fb.group({
            url: this.fb.control(''),
          }),
          formDemande: this.fb.group({
            url: this.fb.control(''),
          }),
          registreCommerce: this.fb.group({
            url: this.fb.control(''),
          }),
          declarationEtablissement: this.fb.group({
            url: this.fb.control(''),
          }),
          photocopieStatus: this.fb.group({
            url: this.fb.control(''),
          }),
          decretMinisteriel: this.fb.group({
            url: this.fb.control(''),
          }),
          avisImmatriculation: this.fb.group({
            url: this.fb.control(''),
          }),
          ...
          contratsTravail: this.fb.group({
            url: this.fb.control(''),
          }),
          cni: this.fb.group({
            url: this.fb.control(''),
          }),
          carteIdentiteConsulaire: this.fb.group({
            url: this.fb.control(''),
          }),

          etatRecensement: this.fb.group({
            url: this.fb.control(''),
          }),
          attestationChomage: this.fb.group({
            url: this.fb.control(''),
          }),
          bulletinsSalaire: this.fb.group({
            url: this.fb.control(''),
          }),
          cessationActivity: this.fb.group({
            url: this.fb.control(''),
          }),
          carteNationaleIdentite: this.fb.group({
            url: this.fb.control(''),
          }),
          manuscriteAdessee: this.fb.group({
            url: this.fb.control(''),
          }),
          passportDoc: this.fb.group({
            url: this.fb.control(''),
          }),
          pieceIdDoc: this.fb.group({
            url: this.fb.control(''),
          }),
          pieceIdGerantDoc: this.fb.group({
            url: this.fb.control(''),
          }),
  ...
  fileChangeEvent(fileInput: any, fileName: string) {
    ...
    if (fileInput.target.files && fileInput.target.files[0]) {
      ...
      reader.onload = (e: any) => {
        ...
        if (fileName == "demandeEcrit" && fileInput.target.files[0].size != 0) {
        ...
        if (fileName == "registerCommerce" && fileInput.target.files[0].size != 0) {
          this.immatForm.get('input').get('documents').get('registreCommerce').get('url').patchValue(docBase64Path);
          
        }
        if (fileName == "declarationEtablissement" && fileInput.target.files[0].size != 0) {
          this.immatForm.get('input').get('documents').get('declarationEtablissement').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "photocopieStatus" && fileInput.target.files[0].size != 0) {
          this.immatForm.get('input').get('documents').get('photocopieStatus').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "decretMinisteriel" && fileInput.target.files[0].size != 0) {
          this.immatForm.get('input').get('documents').get('decretMinisteriel').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "avisImmatriculation" && fileInput.target.files[0].size != 0) {
          this.immatForm.get('input').get('documents').get('avisImmatriculation').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "carteNationaleIdentite" && fileInput.target.files[0].size != 0) {
          this.immatForm.get('input').get('documents').get('carteNationaleIdentite').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "dmt") {
          this.immatForm.get('input').get('documents').get('dmt').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "contratsTravail") {
          this.immatForm.get('input').get('documents').get('contratsTravail').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "cni") {
          this.immatForm.get('input').get('documents').get('cni').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "carteIdentiteConsulaire") {
          this.immatForm.get('input').get('documents').get('carteIdentiteConsulaire').get('url').patchValue(docBase64Path);
          
        }
        if (fileName == "etatRecensement") {
          this.immatForm.get('input').get('documents').get('etatRecensement').get('url').patchValue(docBase64Path);
           
        }
       
        if (fileName == "attestationChomage") {
          this.immatForm.get('input').get('documents').get('attestationChomage').get('url').patchValue(docBase64Path);
        }
        if (fileName == "bulletinsSalaire") {
          this.immatForm.get('input').get('documents').get('bulletinsSalaire').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "cessationActivity") {
          this.immatForm.get('input').get('documents').get('cessationActivity').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "derniersBulletins") {
          this.immatForm.get('input').get('documents').get('derniersBulletins').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "manuscrieAdressee") {
          this.immatForm.get('input').get('documents').get('manuscrieAdressee').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "passportDoc") {
          this.immatForm.get('input').get('documents').get('passportDoc').get('url').patchValue(docBase64Path);
          
        }
        if (fileName == "pieceIdDoc") {
          this.immatForm.get('input').get('documents').get('pieceIdDoc').get('url').patchValue(docBase64Path);
           
        }
        if (fileName == "pieceIdGerantDoc") {
          this.immatForm.get('input').get('documents').get('pieceIdGerantDoc').get('url').patchValue(docBase64Path);
